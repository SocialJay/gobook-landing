...
export default function Footer() {
    return (
        <div className="flex flex-col md:flex-row w-[311px] sm:w-full sm:max-w-[798px] h-[107px] md:h-[52px] gap-6 md:gap-4 justify-between items-center pb-5 md:pb-0">
          ...
          <div className="flex items-center sm:gap-5 gap-8 self-start md:self-center">
            ...
            >
              <FaInstagram size={20} color="#262626" />
            </a>
            <a
            ...
            >
              <FaTiktok size={20} color="#262626" />
            </a>
            <a
              href="mailto:support@gobook.lk"
              aria-label="Email gobook"
            >
              <FaAt size={20} color="#262626" />
            </a>
          </div>
        </div>
    )
