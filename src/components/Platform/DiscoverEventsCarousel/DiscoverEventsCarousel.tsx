...
type DiscoverEventsCarouselProps = {
  events: EventItem[];
  isLoading?: boolean;
};

const DiscoverEventsCarousel = forwardRef<HTMLDivElement, DiscoverEventsCarouselProps>(({
  events,
  isLoading,
}, ref) => {
  ...
  return (
    <div ref={ref} className="flex flex-col gap-5 max-sm:px-4 w-full xl:w-[1200px] lg:w-[864px] md:w-[671px]">
      ...
      {isLoading ? (
        ...
        <div
          ...
          className="discover-carousel flex gap-x-2 md:gap-x-4 xl:gap-x-6 overflow-x-auto select-none cursor-grab active:cursor-grabbing snap-x snap-mandatory"
          style={{
            scrollbarWidth: "none",
...
export default DiscoverEventsCarousel;
