export default function TermsOfService() {
  ...
  return (
    <div className="flex flex-col gap-6 max-w-[600px] mx-auto py-6">
      <h1 className="web-title-1">Terms Of Service</h1>
      <div className="flex flex-col gap-[10px] web-callout">
        <div className="flex flex-col gap-4">
          <div>{`Effective Date: ${today}`}</div>
          <div>
            By using <b>Gobook</b> (“we,” “us,” or “our”), you (“Business”)
            agree to the following Terms & Conditions. If you do not agree with
            any section of these Terms, please discontinue use of our platform
            and services.
          </div>
          ...
          <div>
            ...
            <ul className="mt-2">
              <li className="m-2">
                ...
                <ul>
                  <li className="mb-1">
                    Businesses receive revenue generated from bookings{" "}
                    <b>minus the platform service fee</b>, deposited into their
                    billing account.
                  </li>
                </ul>
              </li>
              ...
              <li className="m-2">
                ...
                <ul>
                  <li className="mb-1">
                    Businesses are fully responsible for fulfilling bookings and
                    delivering the services they list on the platform.
                  </li>
                </ul>
              </li>
              <li className="m-2">
                ...
                <ul>
                  <li className="mb-1">
                    Businesses may access customer data <b>only</b> for internal
                    use related to service delivery. Any misuse, sharing, or
          ...
          <div>
            ...
            <ul className="list-disc pl-5 mt-2">
              ...
              <li>
                Businesses’ net earnings (after fee deductions) are credited to
            ...
            <ul className="mt-2">
              ...
              <li className="m-2">
                ...
                <ul>
                  ...
                  <li className="mb-1">
                    All bookings and payments are processed by Gobook on behalf
                    of the Business.
                  </li>
                </ul>
              </li>
              <li className="m-2">
                ...
                <ul>
                  <li className="mb-1">
                    ...
                    availability, inventory, pricing, or service details listed
                    by Businesses.
                  </li>
                </ul>
              </li>
              <li className="m-2">
                ...
                <ul>
                  <li className="mb-1">
                    Bookings may include per-ticket internet handling fees and a
                    non-refundable order processing fee.
                  </li>
                </ul>
              </li>
              <li className="m-2">
                ...
                <ul>
                  <li className="mb-1">
                    If you do not receive a confirmation (email or confirmation
                    page) after payment, or encounter an interruption during
                    checkout, it is your responsibility to verify the booking
                    through your account or{" "}
                    <a
                      href="mailto:support@gobook.lk"
                      className="underline text-[rgba(255,255,255,0.9)]"
                    >
                      support@gobook.lk
                    </a>
                  </li>
          ...
          <div>
            ...
            <ul className="list-disc pl-5 mt-2">
              <li>
                All booking details must be reviewed{" "}
                <b>before completing payment.</b>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="mt-2">
              <li className="m-2">
                <strong>Business-Initiated Cancellations</strong>
                <br />
                If a Business cancels a booking or event, the customer is
                entitled to a <b>full refund of the booking amount.</b>
                <ul className="list-disc pl-5 mt-2">
                  <li>
                  ...
                  <li>
                    Gobook will facilitate refunds but does not assume liability
                    for cancellations.
                  </li>
                </ul>
              </li>
              <li className="m-2">
                ...
                <ul>
                  <li className="mb-1">
                    ...
                    <b>Business’s own cancellation policy</b>, which must be
                    clearly stated at the time of booking.
                  </li>
                  <li className="mb-1">
          ...
          <div>
            ...
            <ul className="ml-2">
              <li className="mb-1">
                Booking confirmations are delivered electronically via{" "}
                <b>email</b>.
              </li>
              <li className="mb-1">
          ...
          <div>
            ...
            <ul className="ml-2">
              <li className="mb-1">
                If a service or event is cancelled or postponed, the{" "}
                <b>Business</b> is fully responsible for issuing refunds
                according to their policy.
              </li>
              <li className="mb-1">
                Gobook will assist in facilitating the refund but is not liable
                for fulfilling the Business’s obligations.
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc pl-5 mt-2">
              ...
              <li>Businesses must comply with data protection regulations.</li>
              <li>
          ...
          <div>
            ...
            <ul className="list-disc pl-5 mt-2">
              <li>
                Gobook acts solely as a booking facilitator and does not provide
                services directly.
              </li>
              <li>
                We are not responsible for any loss, damage, or disputes related
                to services offered by Businesses.
              </li>
          ...
          <div>
            ...
            <ul className="ml-2">
              ...
              <li className="mb-1">
                Termination does not absolve a Business from paying outstanding
                fees.
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="ml-2">
              <li className="mb-1">We may update these Terms periodically.</li>
              <li className="mb-1">
          ...
          <div>
            ...
            <ul className="ml-2">
              <li className="mb-1">
                ...
                <b>Democratic Socialist Republic of Sri Lanka.</b>
              </li>
              <li className="mb-1">
                Any disputes shall fall under the exclusive jurisdiction of the{" "}
                <b>courts of Colombo, Sri Lanka.</b>
              </li>
            </ul>
          </div>
        </div>
