export default function PrivacyPolicy() {
  ...
  return (
    <div className="flex flex-col gap-6 max-w-[600px] mx-auto py-6">
      <h1 className="web-title-1">Privacy Policy</h1>
      <div className="flex flex-col gap-[10px] web-callout">
        <div className="flex flex-col gap-4">
          ...
          <div>
            ...
            to protecting the personal data of all users (“you”) who access our
            platform, including <b>Businesses</b> offering services and{" "}
            <b>Customers</b> booking services. This Privacy Policy explains how
            we collect, use, store, and share your information, and your rights
            regarding that data. By using our platform, you agree to the
              ...
              <li className="m-2">
                ...
                <ul className="list-disc pl-5 mt-2">
                  <li>
                    ...
                    number, billing address, and other details provided when
                    creating an account or making a booking.
                  </li>
                  <li>
                    <strong>Booking/Service Information:</strong>Details of
                    services booked or offered, dates, times, and notes shared
                    between Tenants and Customers.
                  </li>
                  <li>
                    <strong>Payment Information:</strong>Processed via secure
                    third-party payment providers; full payment credentials are
                    not stored by us.
                  </li>
                  <li>
                    <strong>Usage Data:</strong>IP address, device, browser
                    type, and activity patterns collected via cookies or similar
                    technologies for analytics and improving our platform.
                  </li>
                </ul>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="mt-2">
              <li className="m-2">
                ...
                <ul className="list-disc pl-5 mt-2">
                  <li>Process bookings and manage services.</li>
                  <li>
                    Communicate confirmations, updates, and notifications.
                  </li>
                  <li>Provide customer and tenant support.</li>
                  <li>Personalize and improve the platform experience.</li>
          ...
          <div>
            ...
            <ul className="list-disc pl-5 mt-2">
              <li>
                Tenants may access Customer information{" "}
                <b>only for service delivery purposes</b>. Misuse of data is
                prohibited.
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="list-disc pl-5 mt-2">
              <li>
                Reasonable technical, administrative, and physical measures are
          ...
          <div>
            ...
            <ul className="list-disc pl-5 mt-2">
              <li>
                Personal information is retained while accounts are active or as
          ...
          <div>
            ...
            <ul className="list-disc pl-5 mt-2">
              <li>Our platform is not intended for children under 16.</li>
              <li>
          ...
          <div>
            ...
            <ul className="mt-2">
              <li className="m-2">
                ...
                will be communicated via the platform or email. Continued use of
